...
class Capabilities320Test extends BaseTest {

	@Override
	public Object getValue() {
		return new Capabilities320.Builder().serviceClass(XfsServiceClass.CDM).type(CdmType.SELFSERVICEBILL)
